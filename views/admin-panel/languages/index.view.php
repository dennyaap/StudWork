    ...
    <div class="d-flex" :class="{toggled: isToggledNavbar}" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="/app/controllers/admin-panel/skills/" class="list-group-item list-group-item-action bg-transparent second-text"><i
                        class="fas fa-regular fa-clipboard me-2"></i>Навыки</a>
                <a href="/app/controllers/admin-panel/languages/" class="list-group-item list-group-item-action bg-transparent second-text active"><i class="fas fa-regular fa-clipboard-user me-2"></i>Языки</a>
