      ...
      <div class="forms-container">
        <div class="signin-signup">
          <form action="" class="sign-in-form">
            ...
            <button type="submit" class="btn solid" id="studentAuthBtn"><div class="loading" id="studentSpinner"></div><div id="studentBtnText">Зарегистрироваться</div></button>

            <p class="social-text">Войти</p>
